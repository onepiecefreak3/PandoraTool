...
public class MethodDeclarationParametersSyntax : SyntaxNode
{
    ...
    public MethodDeclarationParametersSyntax(SyntaxToken parenOpen, CommaSeparatedSyntaxList<ExpressionSyntax>? parameters, SyntaxToken parenClose)
    {
    ...
    public void SetParameters(CommaSeparatedSyntaxList<ExpressionSyntax>? parameters, bool updatePosition = true)
    {
        if (parameters != null)
            parameters.Parent = this;
